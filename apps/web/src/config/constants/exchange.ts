...
import { bscTokens, bscTestnetTokens, USDC, USDT, BUSD, WBTC_ETH, SST } from '@pancakeswap/tokens'
import { ChainMap, ChainTokenList } from './types'

export const ROUTER_ADDRESS: ChainMap<string> = {
  [ChainId.ETHEREUM]: '0xcced48e6fe655e5f28e8c4e56514276ba8b34c09',
  [ChainId.RINKEBY]: '0x52B713b60c465d67d992E5964E064313636F9a05', // sepolia
  [ChainId.GOERLI]: '0xEfF92A263d31888d860bD50809A8D171709b7b1c',
  [ChainId.BSC]: '0x10ED43C718714eb63d5aA57B78B54704E256024E',
  [ChainId.BSC_TESTNET]: '0x34f78Aaf34F0B3202d1711e4bFd6de52476d9899',
}

// used to construct intermediary pairs for trading
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  [ChainId.ETHEREUM]: [WNATIVE[ChainId.ETHEREUM], USDC[ChainId.ETHEREUM], USDT[ChainId.ETHEREUM], WBTC_ETH],
  [ChainId.RINKEBY]: [WNATIVE[ChainId.RINKEBY], USDC[ChainId.RINKEBY], SST[ChainId.RINKEBY]],
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.RINKEBY]: [USDC[ChainId.RINKEBY], WNATIVE[ChainId.RINKEBY], SST[ChainId.RINKEBY]],
...
// CAKE
export const DEFAULT_OUTPUT_CURRENCY = '0xc07f892031861467d5551Fc8322699765311B7a3'

// Handler string is passed to Gelato to use PCS router
export const GELATO_HANDLER = 'pancakeswap'
export const GENERIC_GAS_LIMIT_ORDER_EXECUTION = BigNumber.from(500000)

export const LIMIT_ORDERS_DOCS_URL = 'https://SwapStream.finance'
