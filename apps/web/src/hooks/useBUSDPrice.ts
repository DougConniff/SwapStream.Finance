...
import { BUSD, SST, USDC } from '@pancakeswap/tokens'
...
export const useCakeBusdPrice = (
  ...
  const sst: Token = isTestnet ? SST[ChainId.RINKEBY] : SST[ChainId.ETHEREUM]
  return usePriceByPairs(USDC[sst.chainId], sst)
}
