...
export const FACTORY_ADDRESS_MAP: Record<number, string> = {
  ...
  [ChainId.RINKEBY]: '0x52F6d3B5E28E49dD9aB09C0b98BE6B8Ff9e22C8C', // sepolia
...
export const INIT_CODE_HASH_MAP: Record<number, string> = {
  ...
  [ChainId.RINKEBY]: '0x52760dc6e21d771a14d4d9f25e33e291ac680af8eea26a449a8628a2c6666484', // sepolia
...
> = {
  ...
  [ChainId.RINKEBY]: { name: 'Seepolia Ether', symbol: 'SepoliaETH', decimals: 18 },
