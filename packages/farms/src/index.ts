...
const supportedChainId = [ChainId.RINKEBY, ChainId.BSC, ChainId.BSC_TESTNET, ChainId.ETHEREUM]
...
export function createFarmFetcher(multicallv2: MultiCallV2) {
  const fetchFarms = async (
    ...
    const masterChefAddress = isTestnet ? masterChefAddresses[ChainId.RINKEBY] : masterChefAddresses[ChainId.ETHEREUM]
